...
public class DocumentTest {
	...
	public void writeTest() throws IOException, DocumentException {
		...
		table.addRow(new TableCell(tableHeaderCellStyle, document.createParagraph(tableHeaderStyle, "How to ...")), new TableCell(tableHeaderCellStyle, document.createParagraph(tableHeaderStyle, "Code")));
		table.addRow(new TableCell(document.createParagraph(emphaseStyle, "Create a table")), new TableCell(document.createParagraph(codeStyle, "Table table = new Table()")));
		table.addRow(new TableCell(document.createParagraph(emphaseStyle, "Add a row")), new TableCell(document.createParagraph(codeStyle, "table.addRow(TableCell...)")));
		table.addRow(new TableCell(document.createParagraph(emphaseStyle, "Add a cell to a row")), new TableCell(document.createParagraph(codeStyle, "new TableCell(\"text of cell\")")));
		table.addRow(new TableCell(document.createParagraph(emphaseStyle, "Control column width")), new TableCell(document.createParagraph(codeStyle, "table.setColumnWidth(columnIndex, width);")));
		table.addRow(new TableCell(document.createParagraph(emphaseStyle, "Add table to page")), new TableCell(document.createParagraph(codeStyle, "document.addElement(table)")));
		table.addRow(new TableCell(document.createParagraph(emphaseStyle, "Merge rows")).setMergedRows(1), new TableCell(document.createParagraph(codeStyle, "cell.setMergedRows(nbRows)")));
		table.addRow(new TableCell(), new TableCell());
		table.addRow(new TableCell(document.createParagraph(emphaseStyle, "Merge columns"), document.createParagraph(codeStyle, "cell.setMergedColumns(nbColumns)")).setMergedColumns(1));
		table.addRow(new TableCell(document.createParagraph(emphaseStyle, "Repeat header on a new page")), new TableCell(document.createParagraph(codeStyle, "setRepeatHeaderOnNewPage(true)")));
		table.addRow(new TableCell(document.createParagraph(emphaseStyle, "Create a cell style")), new TableCell(document.createParagraph(codeStyle, "TableCellStyle cellStyle = new TableCellStyle()")));
		table.addRow(new TableCell(document.createParagraph(emphaseStyle, "Affect style to cell")), new TableCell(document.createParagraph(codeStyle, "new TableCell(cellStyle, paragraph)")));
		table.addRow(new TableCell(tableFooterCellStyle, document.createParagraph("Add footer")), new TableCell(tableFooterCellStyle, document.createParagraph(codeStyle, "Just create a new row with a different style.")));
