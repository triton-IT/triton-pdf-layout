...
public class TextStyle implements Style, Cloneable {
	 ...
	 */
	protected Integer fontVariantId;
	/**
	...
	/**
	 * Create a default text style. The default style is "no style" and then
	 * style is inherited fromm paragraph.
	 */
	public TextStyle() {
	}
	 ...
	 *            The font variant used to render text under this style.
	 */
	public TextStyle(int fontVariant) {
		this.fontVariantId = fontVariant;
	}
	 ...
	 *            The font size used to render text under this style.
	 */
	public TextStyle(Font font, int fontVariant, float fontSize) {
		this.font = font;
		this.fontVariantId = fontVariant;
		this.fontSize = fontSize;
	}
	 ...
	 *            The font color used to render text under this style.
	 */
	public TextStyle(Font font, int fontVariant, float fontSize, Color fontColor) {
		this.font = font;
		this.fontVariantId = fontVariant;
		this.fontSize = fontSize;
	...
	/**
	 * Set the font of this style. If set to null, the font will be inherited
	 * from paragraph style.
	 * 
	 * @param font
	 *            The font to set to this style.
	 */
	 ...
	 */
	public Integer getFontVariantId() {
		return fontVariantId;
	}

	/**
	 * Set the font variant of this style. If set to null, the font variant will
	 * be inherited from paragraph style.
	 * 
	 * @param fontVariant
	 *            The font variant for this style.
	 */
	public void setFontVariantId(Integer fontVariant) {
		this.fontVariantId = fontVariant;
	}
	...
	/**
	 * Set the font size of this style. If set to null, the font size will be
	 * inherited from paragraph style.
	 * 
	 * @param fontSize
	 *            The font size.
	 */
	...
	/**
	 * Set the font color of this style. If set to null, the font color will be
	 * inherited from paragraph style.
	 * 
	 * @param fontColor
	 *            The color of font.
	...
	/**
	 * Set the underline state of this style. If set to null, the underline
	 * state will be inherited from paragraph style.
	 * 
	 * @param isUnderlined
	 *            The state of underlining.
	 */
	...
	/**
	 * Set the underline color of this style. If set to null, the underline
	 * color will be inherited from paragraph style.
	 * 
	...
	/**
	 * Set the script state of this style. If set to null, the script state will
	 * be inherited from paragraph style.
	 * 
	 * @param script
	 *            The script state.
	...
	public TextStyle clone() {
		TextStyle clone = new TextStyle(font, fontVariantId, fontSize, fontColor);
